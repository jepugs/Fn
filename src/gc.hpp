...
gc_reinitializer undef_initializer;
gc_scavenger undef_scavenger;
...
struct allocator {
    ...
    gc_generation nursery;
    gc_generation survivors;
    gc_generation tenured;
...
gc_header* copy_live_object(istate* S, gc_header* obj);
...
value copy_live_value(istate* S, value v);
